...
public class SpotifyManager: ObservableObject {
  
  static var shared: SpotifyManager = SpotifyManager(with: SpotifyManager.SpotifyDeveloperApplication(
                                                      clientId:     "2979af5bbf724a15914404ef37143116",
                                                      clientSecret: "85a3a4d5e4854170a549ed5e6488353f",
                                                      redirectUri:  "hacknc2020://SpotifyAuthentication"))
  ...
  @objc(SpotifyKit) class SpotifyToken: NSObject, Decodable, NSCoding {
  ...
  public func authorize() {
    ...
    guard !hasToken else { self.delegate?.didSetToken(); return }
